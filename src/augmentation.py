...
class Augmentation:
    ...
    def get_augmentation(self, aug_dict):
        for n, p in aug_dict.items():
            self.transform.append(self._add_augmentation(n, p))
        # self.transform.append(album.Normalize())
        return album.Compose(self.transform)
    ...
    def _add_augmentation(self, aug_name, params):
        if aug_name == 'hflip':
            ...
            return album.Rotate(p=params['p'], 
                                limit=params['limit'])
            ...
            return album.ElasticTransform(p=params['p'],
                                          alpha=params['alpha'],
                                          sigma=params['sigma'],
